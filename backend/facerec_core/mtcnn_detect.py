...
import cv2
import os
from facerec_core.AbstractFaceDetector import AbstractDetector
class MTCNNDetect(object):
    def __init__(self, face_rec_graph, model_path = "./facerec_core/models", threshold = [0.6, 0.7, 0.7], factor = 0.709, scale_factor = 1):
        '''
    ...
    def detect_face(self, img, minsize=80):
        # im: input image
